...
export class ProjectComponent implements OnInit {
  ...
  ListTopics: Topics[] = [
    ...
    { id: 8, name: 'Java', url: 'assets/icon-projects/java.svg' },
    { id: 9, name: 'Csharp', url: 'assets/icon-projects/csharp.svg' },
    { id: 10, name: 'SpringBoot', url: 'assets/icon-projects/spring.svg' },
    { id: 11, name: 'Dart', url: 'assets/icon-projects/dart.svg' },
    { id: 12, name: 'Flutter', url: 'assets/icon-projects/flutter.svg' },
    { id: 13, name: 'Redux', url: 'assets/icon-projects/redux.svg' },
    { id: 14, name: 'Graphql', url: 'assets/icon-projects/graphql.svg' },
    { id: 15, name: 'MySql', url: 'assets/icon-projects/mysql.svg' },
    { id: 16, name: 'PostgreSQL', url: 'assets/icon-projects/postgresql.svg' },
    { id: 17, name: 'MongoDB', url: 'assets/icon-projects/mongodb.svg' },
    { id: 18, name: 'FireBase', url: 'assets/icon-projects/firebase.svg' },
    { id: 19, name: 'Photoshop', url: 'assets/icon-projects/photoshop.svg' },
    {
      id: 16,
      name: 'Illustrator',
